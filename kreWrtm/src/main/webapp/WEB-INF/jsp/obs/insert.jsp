						...
						<div class="ctn_tbl_area">
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<input type="text" id="carNum" name ="carNum" maxlength="6" placeholder="예: 123456" class="form-control input_base_require">
								</div>
							...
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<div class='input-group date' id='datetimepicker1'>
										<input type='text' class="form-cont" name="rptDate" id="rptDate" required/>
							...
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<input type="text" id="obsName" name ="obsName" maxlength="200" placeholder="예: 단말 수신 불량 (최대 200자)" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th fm_rep">처리 내역</div>
								<div class="ctn_tbl_td">
									<input type="text" id="prcComment" name ="prcComment" maxlength="200" placeholder="예: 단말 재부팅 및 상태 확인 (최대 200자)" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th fm_rep">증상 원인</div>
								<div class="ctn_tbl_td">
									<input type="text" id="reason" name ="reason" maxlength="200" placeholder="예: 일시적 통신 품질 저하 (최대 200자)" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
