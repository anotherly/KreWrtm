					...
					<form id="insertForm" name="insertForm" method="post" enctype="multipart/form-data">
						...
						<div class="ctn_tbl_area">
							...
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<input type="text" id="obsName" name ="obsName" maxlength="200" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th fm_rep">처리 내역</div>
								<div class="ctn_tbl_td">
									<input type="text" id="prcComment" name ="prcComment" maxlength="200" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th fm_rep">증상 원인</div>
								<div class="ctn_tbl_td">
									<input type="text" id="reason" name ="reason" maxlength="200" class="form-control input_base_require">
								</div>
							</div>
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th">기타</div>
								<div class="ctn_tbl_td">
									<textarea id="etc" name="etc" style="resize : none; height : 100px;" class="form-control input_base_require" maxlength="1000" wrap="hard"></textarea>
								</div>
							</div>
