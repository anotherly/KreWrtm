...
<script>
	...
	$(function () {
		// 게시판 내용 text area 클릭 시 커서 위치 변경
        $('#boardContent').on('focus click', function () {
            const el = this;
            setTimeout(function () {
					...
					<form id="insertForm" name="insertForm" method="post" enctype="multipart/form-data">
						...
						<div class="ctn_tbl_area">
							...
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<textarea id="boardContent" name="boardContent" style="resize : none; height : 100px;" class="form-control input_base_require" maxlength="2000" wrap="hard"></textarea>
								</div>
							</div>
						</div>
						<!-- btn_box Start -->
